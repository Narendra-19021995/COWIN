<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="COWINSYSTEM.UserLogin" %>
...
<center><p class="heading">Beneficiary Login</p></center>
    <div class="row">
      <div class="col-25">
        <label for="mobile">Mobile</label>
      </div>
      <div class="col-75">
        <asp:TextBox ID="mob" runat="server" class="input" placeholder="Enter Mobile No..." />
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <asp:TextBox ID="id_proof" runat="server" class="input" placeholder="Enter Correct Id No. Mention on Id proof....." />
      </div>
    </div>
    ...
    <div class="col-75">
      <asp:Button ID="Submit" runat="server" class="input" Text="Login" 
